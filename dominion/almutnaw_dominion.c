...
void adventurer_card(int drawntreasure, struct gameState *state, int currentPlayer, int cardDrawn, int *temphand ){
...
int mine_card(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos ){
...
int remodel_card(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos  ){
  int j, i;
